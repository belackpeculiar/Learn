...
<body>
    <div class="container" style="min-height: 100vh;display: flex;align-items: center;justify-content: center;padding: 20px;padding-bottom: 60px;">
        <div class="content" style="text-align: center;">
            <h3 style="font-size: 30px;color: #333;">Hi,<span style="background-color: red; color: #fff; border-radius: 5px; padding: 8px; ">user</span></h3>
            <h1 style="font-size: 50px; color:#333; ">Welcome  <span style="color: red;"><?php echo   $_SESSION['user_name']?></span></h1>
            <p style="font-size: 25px; margin-bottom:20px">This is the user page</p>
